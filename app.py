import os
from flask import Flask, request, jsonify, render_template # <--- التعديل الأول: أضفنا render_template هنا
...
def home():
    # هذا الأمر يخبر Flask بالبحث عن index.html وعرضه
    # (لكن يجب أن يكون index.html داخل مجلد templates)
